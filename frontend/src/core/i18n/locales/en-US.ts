...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 MarketChat, an open source super agent. With built-in and custom skills, MarketChat helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of MarketChat. With customized skills,\nMarketChat can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. MarketChat is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but MarketChat could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "MarketChat's official website",
    githubTooltip: "MarketChat on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "MarketChat on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About MarketChat",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to MarketChat",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate MarketChat faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how MarketChat looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "MarketChat automatically learns from your conversations in the background. These memories help MarketChat understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of MarketChat.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "MarketChat only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "MarketChat",
