...
# Install MarketChat Harness

<Callout type="info" emoji="📦">
  The MarketChat Harness Python package will be published as <code>deerflow</code>
  . It is not released yet, so installation is currently{" "}
  <strong>Coming Soon</strong>.
</Callout>

The MarketChat Harness is the Python SDK and runtime foundation for building your own Super Agent systems.

If you want to compose agents with skills, memory, tools, sandboxes, and subagents inside your own product or workflow, this is the part of MarketChat you will build on.
...
The MarketChat Harness package is **coming soon**.
...
The Harness is designed for developers who want to build their own agent system on top of MarketChat's runtime model.
...
- integrating MarketChat into your own application architecture.

## What to do next

Until the package is released, the best way to understand the MarketChat Harness is to read the conceptual and implementation docs in this section.
